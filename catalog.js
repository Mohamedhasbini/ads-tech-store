...
(function () {
  ...
  function card(p) {
    ...
    return '<div class="pc" data-c="' + esc(p.category) + '" data-slug="' + esc(p.slug) + '">' +
      '<div class="pc-img">' + badge +
      (p.img ? '<img src="' + esc(p.img) + '" alt="' + esc(p.brand + " " + p.name) + '" loading="lazy">'
             : '<div class="pc-ph"><span class="pc-ph-b">' + esc(p.brand || "ADS TECH") + '</span>' +
               '<span class="pc-ph-c">' + esc(p.category || "") + '</span>' +
